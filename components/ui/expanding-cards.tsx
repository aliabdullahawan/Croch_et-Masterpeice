      ...
      {items.map((item, index) => (
        ...
        >
          ...
          >
            ...
            <Link
              href={item.linkHref}
              className="inline-flex w-fit items-center rounded-md bg-white/20 px-3 py-1.5 text-xs font-medium text-white opacity-0 transition-all duration-300 delay-300 ease-out hover:bg-white/30 group-data-[active=true]:opacity-100"
            >
              Explore
            </Link>
          </article>
