      ...
      <div className="w-full max-w-md">
        ...
        {sent ? (
          ...
          <div className="glass-card p-8">
            ...
            {error && (
              <div className="bg-brand-rose/10 border border-brand-rose/30 text-brand-rose text-sm px-4 py-3 rounded-xl mb-5">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="submit" disabled={loading}
                className="btn-gold w-full flex items-center justify-center gap-2 py-3.5 disabled:opacity-70 transition-transform hover:scale-102 active:scale-95"
