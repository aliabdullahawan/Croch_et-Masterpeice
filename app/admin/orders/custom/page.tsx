...
export default function CustomOrdersPage() {
  ...
  return (
    <PageTransition className="p-4 md:p-6 pb-16">
      ...
      <div className="mb-6 bg-[rgba(42,22,10,0.6)] border border-[rgba(201,160,40,0.15)] rounded-2xl p-4 md:p-5">
        <div className="flex items-center gap-2 mb-4">
          <UserPlus size={16} className="text-[#C9A028]" />
          <h2 className="font-display text-lg text-[#F2E9DE]">Add Manual Custom Order</h2>
        </div>

        <form onSubmit={submitManualOrder} className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            <label className="text-xs text-[#C8B89A]">
              Link User (Optional)
              <select
                value={form.user_id}
                onChange={(e) => onSelectCustomer(e.target.value)}
                className="mt-1 w-full rounded-lg bg-[rgba(28,18,8,0.85)] border border-[rgba(201,160,40,0.2)] px-3 py-2 text-[#F2E9DE]"
              >
          ...
          <label className="text-xs text-[#C8B89A] block">
            Description *
            <textarea
          ...
          <button
            type="submit"
            disabled={creating}
            className="px-4 py-2 rounded-xl bg-[rgba(201,160,40,0.2)] border border-[rgba(201,160,40,0.3)] text-[#F2E9DE] text-sm hover:bg-[rgba(201,160,40,0.3)] transition disabled:opacity-60"
          >
